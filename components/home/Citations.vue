  ...
  <section class="citations">
    ...
    >
      <div
        ...
        :key="index"
        class="quote"
        :style="{ 'left': `${index + 1}00%`, 'transform':`translateX(-${carouselCount * 100}%)` }"
      >
        <blockquote>
          <p>{{ item.quote }}</p>
          <h2>{{ item.author }}</h2>
...
export default {
    ...
    data () {
        return {
            items: [
                {
                    quote: '“J’ai toujours rêvé que mon ordinateur soit aussi simple à utiliser que mon téléphone. Ce rêve est devenu réalité : je ne comprends plus comment utiliser mon téléphone”',
                    author: 'Bjarne Stroustrup'
                },
                {
                    quote: '“Le manuel disait « Nécessite Windows XP ou mieux ». J’ai donc installé Linux.”',
                ...
                {
                    quote: '“Je ne suis pas asocial, je ne suis juste pas orienté utilisateur.”',
                    author: 'Peter Funk'
                }
            ],
            scrollInterval: null,
